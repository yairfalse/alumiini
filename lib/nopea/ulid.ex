defmodule Nopea.ULID do
  @moduledoc """
  Monotonic ULID (Universally Unique Lexicographically Sortable Identifier) generator.

  Generates ULIDs compatible with CDEvents and observability systems.
  ...
  This is critical for event causality tracking and time-series storage.

  ## Example

      iex> Nopea.ULID.generate()
  ...
  """
  @spec generate_with_timestamp(DateTime.t() | integer()) :: String.t()
  ...
  Useful for tests or when Agent is not running.
  """
  ...
  """
  @spec parse(String.t()) ::
          {:ok, {integer(), integer()}} | {:error, :invalid_length | :invalid_character}
  ...
  """
  @spec timestamp(String.t()) :: {:ok, DateTime.t()} | {:error, term()}
